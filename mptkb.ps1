...
function Review-Next
{
    ...
    $selected_link = ($results.GetEnumerator() | Sort-Object -Property @{Expression={$_.Prio}; Descending=$false}, @{Expression={$_.NodeId} ;Descending=$true} | Select-Object -First 100 | Get-Random).NodeId
